package main_study.json_tcpchat.day24.jsonbased_chatting;
...
public class ChatServer {
    ...
    public ExecutorService threadPool = Executors.newFixedThreadPool(100); //100개의 클라이언트가 동시에 채팅할 수 있도록 운영하기 위해
    Map<String, SocketClient> chatRoom = new ConcurrentHashMap<>(new HashMap<>()); //통신용 SocketClient를 관리하는 동기화된 Map 컬렌션이다.
    //싱크로나이즈 처리될때 동안 다른거 스탑 걸어놓는거
